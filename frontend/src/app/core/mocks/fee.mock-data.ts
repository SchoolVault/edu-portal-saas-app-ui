...
export const MOCK_FEE_PAYMENTS_SEED: FeePayment[] = [
  { id: 1, studentId: 1, studentName: 'Arjun Patel', feeStructureId: 1, amount: 3850, paidAmount: 3850, dueAmount: 0, status: 'paid', paymentDate: '2025-07-15', dueDate: '2025-07-31', discount: 0, lateFee: 0, receiptNumber: 'REC-2025-001', paymentMethod: 'UPI', tenantId: 't1' },
  { id: 2, studentId: 2, studentName: 'Emily Watson', feeStructureId: 2, amount: 6200, paidAmount: 3100, dueAmount: 3100, status: 'partial', paymentDate: '2025-07-20', dueDate: '2025-07-31', discount: 0, lateFee: 0, receiptNumber: 'REC-2025-002', paymentMethod: 'NETBANKING', tenantId: 't1' },
  ...
  { id: 4, studentId: 4, studentName: 'Sofia Martinez', feeStructureId: 2, amount: 6200, paidAmount: 6200, dueAmount: 0, status: 'paid', paymentDate: '2025-07-10', dueDate: '2025-07-31', discount: 500, lateFee: 0, receiptNumber: 'REC-2025-003', paymentMethod: 'CASH', tenantId: 't1' },
  ...
  { id: 6, studentId: 10, studentName: 'Charlotte Wilson', feeStructureId: 3, amount: 8200, paidAmount: 8200, dueAmount: 0, status: 'paid', paymentDate: '2026-01-05', dueDate: '2026-01-31', discount: 0, lateFee: 0, receiptNumber: 'REC-2026-001', paymentMethod: 'NEFT', tenantId: 't1' },
  { id: 7, studentId: 11, studentName: 'Oliver Taylor', feeStructureId: 3, amount: 8200, paidAmount: 4000, dueAmount: 4200, status: 'partial', paymentDate: '2026-01-10', dueDate: '2026-01-31', discount: 0, lateFee: 0, receiptNumber: 'REC-2026-002', paymentMethod: 'UPI', tenantId: 't1' },
  { id: 8, studentId: 12, studentName: 'Emma Chen', feeStructureId: 2, amount: 6200, paidAmount: 4800, dueAmount: 1400, status: 'partial', paymentDate: '2025-08-01', dueDate: '2025-07-31', discount: 0, lateFee: 0, receiptNumber: 'REC-2025-004', paymentMethod: 'CARD', tenantId: 't1' },
  ...syntheticFeePayments(),
];

/** Extra payment-ledger rows so pagination & search stay realistic in mock mode. */
function syntheticFeePayments(): FeePayment[] {
  ...
  for (let i = 0; i < 34; i++) {
    ...
    out.push({
      ...
      paymentMethod: status === 'paid' || status === 'partial' ? (i % 2 === 0 ? 'UPI' : 'NETBANKING') : undefined,
      tenantId: 't1',
    });
  }
  return out;

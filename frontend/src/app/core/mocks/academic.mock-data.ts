...
{ id: 1, name: 'Class 1', grade: 1, sections: [{ id: 101, name: 'A', classId: 1, capacity: 40, studentCount: 35 }, { id: 102, name: 'B', classId: 1, capacity: 40, studentCount: 38 }], classTeacherId: 7, classTeacherName: 'Aisha Khan', academicYearId: 1, tenantId: 't1' },
{ id: 2, name: 'Class 2', grade: 2, sections: [{ id: 201, name: 'A', classId: 2, capacity: 40, studentCount: 36 }], academicYearId: 1, tenantId: 't1' },
{ id: 3, name: 'Class 3', grade: 3, sections: [{ id: 301, name: 'A', classId: 3, capacity: 40, studentCount: 34 }, { id: 302, name: 'B', classId: 3, capacity: 40, studentCount: 37 }], academicYearId: 1, tenantId: 't1' },
{ id: 4, name: 'Class 4', grade: 4, sections: [{ id: 401, name: 'A', classId: 4, capacity: 40, studentCount: 39 }], academicYearId: 1, tenantId: 't1' },
...
{ id: 7, name: 'Class 7', grade: 7, sections: [{ id: 701, name: 'A', classId: 7, capacity: 40, studentCount: 36 }, { id: 702, name: 'B', classId: 7, capacity: 40, studentCount: 34 }, { id: 703, name: 'C', classId: 7, capacity: 40, studentCount: 33 }], academicYearId: 1, tenantId: 't1' },

...
export const AppPermission = {
  ...
  SCHOOL_COMMUNICATION_PUBLISH: 'SCHOOL_COMMUNICATION_PUBLISH',
  SCHOOL_COMMUNICATION_MESSAGE_SEND: 'SCHOOL_COMMUNICATION_MESSAGE_SEND',
  SCHOOL_DIRECTORY_READ: 'SCHOOL_DIRECTORY_READ',
  SCHOOL_DIRECTORY_WRITE: 'SCHOOL_DIRECTORY_WRITE',
  SCHOOL_DOCUMENTS_READ: 'SCHOOL_DOCUMENTS_READ',
  SCHOOL_DOCUMENTS_WRITE: 'SCHOOL_DOCUMENTS_WRITE',
  ...
  FEE_FINANCE_READ: 'FEE_FINANCE_READ',
  FEE_CONFIG_WRITE: 'FEE_CONFIG_WRITE',
  FEE_BILLING_WRITE: 'FEE_BILLING_WRITE',
  FEE_REFUND_REQUEST: 'FEE_REFUND_REQUEST',
  FEE_REFUND_APPROVE: 'FEE_REFUND_APPROVE',
  FEE_ONLINE_CHECKOUT: 'FEE_ONLINE_CHECKOUT',
  ...
  SCHOOL_LIBRARY_ANALYTICS_READ: 'SCHOOL_LIBRARY_ANALYTICS_READ',
  SCHOOL_LIBRARY_POLICY_WRITE: 'SCHOOL_LIBRARY_POLICY_WRITE',
  SCHOOL_LIBRARY_RESERVATION_WRITE: 'SCHOOL_LIBRARY_RESERVATION_WRITE',
  SCHOOL_LIBRARY_INVENTORY_WRITE: 'SCHOOL_LIBRARY_INVENTORY_WRITE',
  SCHOOL_LIBRARY_REMINDER_READ: 'SCHOOL_LIBRARY_REMINDER_READ',

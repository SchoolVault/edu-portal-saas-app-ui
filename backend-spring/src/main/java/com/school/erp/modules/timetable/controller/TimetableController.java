...
public class TimetableController {
    ...
    @GetMapping @Operation(summary = "Get timetable entries by class and section")
    ...
    @GetMapping("/grid") @Operation(summary = "Get timetable as grid (day x period)", description = "Returns structured grid ready for UI rendering")
    ...
    @GetMapping("/teacher/{teacherId}") @Operation(summary = "Get teacher's complete schedule")
    ...
    @PostMapping @PreAuthorize("hasRole('ADMIN')") @Operation(summary = "Create timetable entry", description = "Auto-checks for class and teacher conflicts")
    ...
    @PostMapping("/batch") @PreAuthorize("hasRole('ADMIN')") @Operation(summary = "Batch create entries")
    ...
    @PutMapping("/{id}") @PreAuthorize("hasRole('ADMIN')") @Operation(summary = "Update timetable entry")
    ...
    public ResponseEntity<ApiResponse<Void>> delete(@PathVariable Long id) {
        service.deleteEntry(id); return ResponseEntity.ok(ApiResponse.ok(null, "Deleted"));
    }
}

...
public class HostelController {
    ...
    @GetMapping("/rooms") @Operation(summary = "List rooms with current residents")
    ...
    @PostMapping("/rooms") @PreAuthorize("hasRole('ADMIN')") @Operation(summary = "Create room")
    ...
    @PostMapping("/allocate") @PreAuthorize("hasRole('ADMIN')") @Operation(summary = "Allocate student to room", description = "Checks capacity before allocation. Returns error if room is full.")
    ...
    @PutMapping("/vacate/{allocationId}") @PreAuthorize("hasRole('ADMIN')") @Operation(summary = "Vacate student from room", description = "Sets status to VACATED, decreases room occupancy")
    ...
    @GetMapping("/stats") @Operation(summary = "Hostel statistics", description = "Total rooms, capacity, occupancy, available beds")

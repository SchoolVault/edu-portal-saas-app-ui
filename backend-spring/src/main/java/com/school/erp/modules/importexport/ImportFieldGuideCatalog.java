...
public final class ImportFieldGuideCatalog {
    ...
    private static List<ImportExportDTOs.ImportFieldGuide> timetableGuides() {
        return List.of(
                ...
                guide("subject_name", true, "Catalog display name (e.g. Mathematics).", "Mathematics"),
                guide("subject_code", false, "Stable mnemonic code (e.g. MATH); optional if same as noisy full-name duplication.", "MATH"),
